...
export const metadata: Metadata = {
  title: "Data Assembly Network",
  description: "Interactive node network visualization",
  generator: "v0.dev",
}
