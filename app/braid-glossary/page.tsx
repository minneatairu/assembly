...
export default function BraidGlossaryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.licenseCheck) {
      setError("Please confirm that this braid is either your original work, in the public domain, or covered by a license such as Creative Commons.")
      return
    }
              ...
              <div className="p-0">
                ...
                {submissionType === "photo" ? (
                  ...
                  <div className="flex h-full">
                    ...
                    <div className="w-1/2">
                      <div
                        className={`relative bg-[rgb(254,228,107)] border-r-2 border-black transition-colors ${
                    ...
                    <div className="w-1/2 flex flex-col">
                      <div className="flex-1 flex flex-col min-h-[500px] overflow-y-auto">
                        ...
                        <input
                          ...
                          className="h-20 px-4 bg-white border-b-2 border-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent stick-no-bills text-black placeholder-black text-3xl sm:text-2xl md:text-3xl"
                          required
                        />
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="h-20 px-4 bg-white border-b-2 border-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent stick-no-bills text-black text-3xl sm:text-2xl md:text-3xl"
                        >
                        ...
                        <div className="min-h-20 px-4 bg-white border-b-2 border-black">
                          <div className="py-2">
                            <div className="flex items-center justify-between">
                              <label className="stick-no-bills text-black text-3xl sm:text-2xl md:text-3xl">
                                Braid Patterns
                              </label>
                              <button
                                type="button"
                        ...
                        {/* Credit Section */}
                        <div className="bg-gray-50 px-4 py-2 border-b-2 border-black">
                          <h3 className="stick-no-bills text-black text-xl font-semibold mb-2 uppercase">Credits</h3>
                        </div>
                        ...
                        <div className="max-w-2xl mx-auto space-y-0">
                          ...
                          <div className="relative">
                            <textarea
                              ...
                              rows={4}
                              className="w-full p-4 bg-white border-b-2 border-black text-gray-700 placeholder-black stick-no-bills text-3xl sm:text-2xl md:text-3xl focus:outline-none focus:border-black resize-none"
                            />
                          </div>
                          ...
                          <select
                            ...
                            value={formData.braidFamily ?? ""}
                            onChange={handleInputChange}
                            className="w-full p-4 bg-white border-b-2 border-black text-gray-700 stick-no-bills text-3xl sm:text-2xl md:text-3xl focus:outline-none focus:border-black"
                          >
                            {braidFamilyOptions.map((option) => (
                              <option key={option.value} value={option.value} className="stick-no-bills text-gray-700">
                                {option.label}
                              </option>
                            ))}
                          </select>
                          ...
                          <div className="p-4 bg-white border-b-2 border-black">
                            <div className="flex items-center justify-between mb-2">
                              <label className="stick-no-bills text-gray-700 text-3xl sm:text-2xl md:text-3xl">
                                Braid Patterns
                              </label>
                              <button
                                type="button"
                          ...
                          {/* Credit Section for Link */}
                          <div className="p-4 bg-gray-50 border-b-2 border-black">
                            <h3 className="stick-no-bills text-gray-700 text-xl font-semibold mb-2 uppercase">
                              Credits
                            </h3>
                          </div>
                ...
                <div className="flex items-start gap-3 p-4">
                  ...
                  <label htmlFor="agreeToShare" className="stick-no-bills text-black leading-relaxed">
                    I certify that I have the rights to submit this braid for inclusion in The Braid Intelligence Dataset (B.I.D.).
                  </label>
                </div>
                ...
                <div className="flex items-start gap-3 p-4">
                  ...
                  <label htmlFor="licenseCheck" className="stick-no-bills text-black leading-relaxed">
                    This braid is either my original work, in the public domain, or covered by a license such as Creative Commons.
                  </label>
                </div>
                ...
                <div className="p-4 space-y-4">
                  <input
                    ...
                    className="w-full p-3 bg-gray-50 border-b-2 border-black text-gray-700 placeholder-black stick-no-bills text-3xl sm:text-2xl md:text-3xl focus:outline-none focus:border-black"
                    required
                  />
                  <input
                    type="password"
                ...
                <div className="p-4">
                  <button
                    ...
                    disabled={submitting}
                    className="w-full py-4 bg-[rgb(254,228,107)] text-black text-3xl sm:text-2xl md:text-3xl hover:bg-[rgb(244,218,97)] transition-colors stick-no-bills border-2 border-black font-bold disabled:opacity-50 disabled:cursor-not-allowed uppercase"
                  >
