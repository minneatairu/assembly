...
export default function BraidGlossaryPage() {
  ...
  const [showBraidFamilies, setShowBraidFamilies] = useState(false)
  ...
  const [formData, setFormData] = useState({
    ...
    region: "",
    era: "",
    braidFamily: [] as string[], // Changed from string to array
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newBraid = await db.addBraid({
        ...
        braid_family: formData.braidFamily.length > 0 ? formData.braidFamily : undefined,
  ...
  // Handle braid family checkbox changes
  const handleBraidFamilyChange = (family: string, checked: boolean) => {
    setFormData((prev) => ({
      ...prev,
      braidFamily: checked ? [...prev.braidFamily, family] : prev.braidFamily.filter((f) => f !== family),
    }))
  }
          ...
          <div className="relative w-full max-w-4xl bg-black border-dotted border-2 border-black p-6 overflow-y-auto max-h-[90vh]">
            ...
            <div className="flex items-center justify-between mb-0 px-0 py-0">
              ...
              <div className="relative">
                ...
                {showDropdown && (
                  <div className="absolute top-full left-0 w-full bg-[rgb(254,228,107)] border-l-dotted border-l-2 border-r-dotted border-r-2 border-b-dotted border-b-2 border-black z-20">
                    {submissionOptions.map((option) => (
                      <button
                        ...
                        className={`w-full h-12 px-4 text-left stick-no-bills text-black text-3xl sm:text-2xl uppercase hover:bg-[rgb(244,218,97)] transition-colors border-black last:border-b-0 border-b-dotted border-b-2 md:text-5xl bg-pink-100 py-0 ${
                  ...
                  <div className="bg-white p-4 px-0 py-0">
                    <div className=" min-w-[400px] mx-auto space-y-0 bg-black">
                      ...
                      <div className="border-dotted border-black mb-3 mt-0 bg-yellow-300 border-0">
                        <div className="px-4 border-b-dotted border-b-2 border-black bg-yellow-200 mt-8 py-0">
                      ...
                      >
                        ...
                        <div className="p-0">
                          <input
                            ...
                            className="w-full py-4 px-4 bg-yellow-200 border-b-dotted border-b-2 border-black border-solid focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent stick-no-bills text-black placeholder-black text-5xl"
                          />
                          <input
                            type="text"
                            name="stylist"
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            placeholder="Https://"
                            className="w-full px-4 bg-yellow-200 border-b-dotted border-b-2 border-black border-solid text-gray-700 placeholder-black stick-no-bills text-5xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent py-4"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    {submissionType === "link" ? (
                      ...
                      <div className="p-8 px-0 py-0 bg-black">
                        <div className="min-w-[400px] mx-auto space-y-6">
                          ...
                          <div className="border-dotted border-black bg-gray-50 border-0 mb-4 mt-8">
                            <div className="px-4 py-2 border-b-dotted border-b-2 border-black bg-yellow-200">
                            ...
                            <div className="p-0 bg-amber-200">
                              ...
                              <input
                                ...
                                onChange={handleInputChange}
                                placeholder="Braid Name"
                                className="w-full py-4 px-4 bg-yellow-200 border-b-dotted border-b-2 border-black border-solid text-gray-700 placeholder-black stick-no-bills text-5xl focus:outline-none focus:border-black"
                                required
                              />
                          ...
                          <div className="border-dotted border-2 border-black mb-4 mt-6">
                            ...
                            <div className="p-0">
                              ...
                              <input
                                ...
                                onChange={handleInputChange}
                                placeholder="Era"
                                className="w-full px-4 bg-yellow-200 border-b-dotted border-b-2 border-black border-solid text-black placeholder-black stick-no-bills text-5xl focus:outline-none focus:border-transparent py-4"
                              />

                              <div className="min-h-16 px-4 bg-yellow-200 border-b-dotted border-b-2 border-black my-0 py-3.5">
                                <div className="py-2">
                                  <div className="flex items-center justify-between">
                                    <label className="stick-no-bills text-black text-5xl">Braid Family</label>
                                    <button
                      ...
                      <div className="p-8 px-0 py-0 bg-black">
                        <div className="min-w-[400px] mx-auto space-y-6">
                          ...
                          {audioSupported && (
                            <div className="p-4 border-dotted border-2 border-black border-none bg-yellow-200 py-16 mb-0">
                              <div className="flex flex-col items-center justify-center min-h-[120px]">
                                {!isRecording && !audioBlob && (
                                  <button
                                    type="button"
                                    onClick={startRecording}
                                    className="px-6 text-black hover:bg-lime-500 font-medium stick-no-bills border-dotted border-2 border-black uppercase bg-rose-200 text-5xl border-solid py-6"
                                  >
                                    START RECORDING
                                  </button>
                                )}
                          ...
                          <div className="border-dotted border-2 border-black bg-gray-50 mb-6 border-none">
                            ...
                            <div className="p-0">
                              ...
                              <div className="min-h-16 px-4 bg-yellow-200 border-b-dotted border-b-2 border-black py-3.5">
                                <div className="py-2">
                                  <div className="flex items-center justify-between">
                                    <label className="stick-no-bills text-black text-5xl">Braid Family</label>
                                    <button
                ...
                <div className="p-0">
                  ...
                  <div className="p-8 bg-white">
                    ...
                    <div className="space-y-0">
                      ...
                      {/* Braid Family - inline */}
                      {showDetailModal.braid_family && showDetailModal.braid_family.length > 0 && (
                        <div className="flex items-center gap-4">
                          <span className="text-xl font-semibold stick-no-bills text-black uppercase min-w-fit">
                            Braid Family
                          </span>
                          <span className="stick-no-bills text-black uppercase text-xl">
                            ({" "}
                            {Array.isArray(showDetailModal.braid_family)
                              ? showDetailModal.braid_family.map((family) => family.replace("-", " ")).join(", ")
