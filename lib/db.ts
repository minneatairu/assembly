...
const DB_URL = process.env.NEON_NEON_NEON_NEON_NEON_NEON_NEON_NEON_NEON_DATABASE_URL
...
const DEMO_BRAIDS: Braid[] = [
  {
    ...
    region: "West Africa",
    era: "Ancient",
    braid_family: "cornrows",
    braid_patterns: ["s-curve", "diamond-grid"],
  ...
  },
  {
    ...
    region: "Scandinavia",
    era: "Viking Age",
    braid_family: "two-strand-twist",
    braid_patterns: ["chevron", "j-curve"],
  ...
  },
  {
    ...
    region: "West Africa",
    era: "Traditional",
    braid_family: "feed-in",
    braid_patterns: ["u-curve", "heart-shaped"],
  ...
  async addBraid(braid: Omit<Braid, "id" | "created_at" | "updated_at">): Promise<Braid> {
    ...
    try {
      ...
      const result = await sql`
        INSERT INTO braids (braid_name, alt_names, region, era, braid_family, braid_patterns, image_url, public_url, contributor_name, audio_url, audio_notes)
        VALUES (${braid.braid_name}, ${braid.alt_names || null}, ${braid.region}, ${braid.era || null}, ${braid.braid_family || null}, ${braid.braid_patterns ? JSON.stringify(braid.braid_patterns) : null}, ${braid.image_url || null}, ${braid.public_url || null}, ${braid.contributor_name}, ${braid.audio_url || null}, ${braid.audio_notes || null})
        RETURNING *
      `
